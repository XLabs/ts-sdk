...
import type { Layout, Item, LengthPrefixed } from "./layout.js";
import { serializeNum, getCachedSerializedFrom } from "./serialize.js";
import { isNumType, isFixedBytesConversion, bytesItemHasLayout } from "./utils.js";
import { calcStaticSize } from "./size.js";

type LayoutIndex = number;

export type Discriminator<B extends boolean = false> =
  (encoded: RoUint8Array) => B extends false ? LayoutIndex | null : readonly LayoutIndex[];
