...
import { calcSizeForSerialization } from "./size.js";
import {
  checkItemSize,
  checkBytesTypeEqual,
  checkNumEquals,
...
const cursorWrite = (cursor: Cursor, bytes: RoUint8Array) => {
...
export function getCachedSerializedFrom(
  ...
  const custom =
    item.custom as FixedConversion<LayoutObject, any> & { cachedSerializedFrom?: RoUint8Array };
