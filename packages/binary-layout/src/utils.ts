...
export const isFixedBytesConversion = (custom: any): custom is FixedConversion<RoUint8Array, any> =>
  isUint8Array(custom?.from);
...
export const checkBytesTypeEqual = (
  ...
  const toSlice = (bytes: RoUint8Array, slice?: number | readonly [number, number]) =>
    slice === undefined
